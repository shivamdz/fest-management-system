                                 ...
                                 <div class="row">
                                   <div class="col-md-12">
                                       <div class="form-group">
                                           ...
                                           <input id="labeltcolor" type="text" name="Contact" class="form-control border-input" placeholder="Head Contact No" maxlength="10" pattern="^[1-9]\d{9}$" title="Please enter correct Mobile no." required>
                                       </div>
                                   </div>
                                 </div>
                              <div class="row">
