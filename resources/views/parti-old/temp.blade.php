...
<head>
    ...
    <!-- Bootstrap core CSS     -->
	<link href="{{asset('parti-assets/css/bootstrap.min.css')}}" rel="stylesheet" />
  <!-- <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous"> -->

	<link href="{{asset('parti-assets/css/paper-kit.css')}}" rel="stylesheet"/>

	<!--  CSS for Demo Purpose, don't include it in your project     -->
	<link href="{{asset('parti-assets/css/demo.css')}}" rel="stylesheet" />

    <!--     Fonts and icons     -->
    <link href='http://fonts.googleapis.com/css?family=Montserrat:400,300,700' rel='stylesheet' type='text/css'>
    <link href="http://maxcdn.bootstrapcdn.com/font-awesome/latest/css/font-awesome.min.css" rel="stylesheet">
    <link href="{{asset('parti-assets/css/nucleo-icons.css')}}" rel="stylesheet" />
...
<!-- Core JS Files -->
<script src="{{asset('parti-assets/js/jquery-3.2.1.js')}}" type="text/javascript"></script>
<script src="{{asset('parti-assets/js/jquery-ui-1.12.1.custom.min.js')}}" type="text/javascript"></script>
<script src="{{asset('parti-assets/js/popper.js')}}" type="text/javascript"></script>
...
<!-- Switches -->
<script src="{{asset('parti-assets/js/bootstrap-switch.min.js')}}"></script>

<!--  Plugins for Slider -->
<script src="{{asset('parti-assets/js/nouislider.js')}}"></script>

<!--  Plugins for DateTimePicker -->
<script src="{{asset('parti-assets/js/moment.min.js')}}"></script>
<script src="{{asset('parti-assets/js/bootstrap-datetimepicker.min.js')}}"></script>

<!--  Paper Kit Initialization and functons -->
<script src="{{asset('parti-assets/js/paper-kit.js')}}"></script>
